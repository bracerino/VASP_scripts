...
if len(lines)>2:
    ...
    lines[-1] = "{} {}\t{} {}\t{} {} {} {} {} {}\t{} {} {} {} {} {}\n".format(lines[-1].strip(), str(time_trails),  str(f"{round(calc.energy.to_numpy(), 7):.7f}"), str(change), 
    ...
    time_trails=round(float(sys.argv[2]) / 60, 2)
    time_trails = f"{time_trails:.2f}"
    lines[-1] = "{} {}\t{} {}\t{} {} {} {} {} {}\t{} {} {} {} {} {}\n".format(lines[-1].strip(), str(time_trails), str(f"{round(calc.energy.to_numpy(), 7):.7f}"), str("+0.0000"), 
    str(para_a), str(para_b),str(para_c), str(alpha), str(beta), str(gamma), 
