...
directory_path="/home/lebedmi2/VASP_calculations_ALL/test_only/9Cu_9Ni/VASP_calc"
...
if [ -d "$directory_path" ]; then
    ...
    echo "#Ener_Cutoff[eV] Elapsed_Time[min] Total_Ener[eV] Ener_Diff[eV] Latt_a[A] Latt_b[A] Latt_c[A] Alpha[°] Beta[°] Gamma[°] a_Diff[A] b_Diff[A] c_Diff[A] Alp_Diff[°] Beta_Diff[°] Gamma_Diff[°]" >> "$output_file"
