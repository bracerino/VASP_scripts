...
directory_path="/home/lebedmi2/VASP_calculations_ALL/test_only/Fe_bcc/Fe_bcc_1x1x2_Ecut_test"
...
if [ -d "$directory_path" ]; then
    ...
    echo "#k_sampling [A-1] k_a k_b k_c Elapsed_Time[min] Total_Ener[eV] Ener_Diff[eV] Latt_a[A] Latt_b[A] Latt_c[A] Alpha[°] Beta[°] Gamma[°] a_Diff[A] b_Diff[A] c_Diff[A] Alp_Diff[°] Beta_Diff[°] Gamma_Diff[°]" >> "$output_file"
    previous_values=""
    current_values=1
